...
export const Room = () => {
  ...
  return (
    ...
    >
      {/* ゲーム画面 */}
      <div
        className="relative w-full max-w-4xl bg-black border-2 border-gray-700 md:mt-8 sm:mt-16 aspect-video mb-48 md:mb-16 lg:mb-4  sm:aspect-[16/9] md:aspect-[16/16] lg:aspect-[21/21]"
        style={{
          WebkitUserSelect: 'none' /* Safari */,
          userSelect: 'none',
        }}
